...
IntRate = float(input("Enter the annual interest rate-->"))
IntRate = IntRate/100
CompNum = float(input("Enter the number of compounding periods-->"))
Length = float(input("Enter the length of the investment period in years-->"))
FinalAmount = (1+IntRate/CompNum)**(CompNum*Length) * Prin
FinalAmount = round(FinalAmount,2)
print(f"Your final amount is ${FinalAmount}")
IntEarned = FinalAmount - Prin
IntEarned = round(IntEarned,2)
print(f"Your interest earned is ${IntEarned}")